...
-- Reorder one like within its device's playlist (drag-and-drop support).
create or replace function set_position(p_device uuid, p_artist text, p_song text, p_position int)
returns void
language sql
security definer
set search_path = ''
